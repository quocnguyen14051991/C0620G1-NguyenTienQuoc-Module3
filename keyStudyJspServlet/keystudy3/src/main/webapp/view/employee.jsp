        ...
        <div class="table-wrapper">
            <div class="table-title">
                <div class="row">
                    <div class="col-xs-8">
                        <div class="row">
                            <div class="col-xs-5"><h2>Manage <b>Employee</b></h2>
                            </div>
                            <div class="col-xs-7"><!-- Search form -->
                                <form class="form-inline d-flex justify-content-center md-form form-sm active-cyan active-cyan-2 mt-2" action="/employee">
                                    ...
                                    <div class="row">
                                        ...
                                        <button type="button" class="btn btn-primary" style="margin-left: 3px">Search</button>
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <a href="#" class="delete" data-toggle="modal" data-target="#deleteEmployeeModal"
                               onclick="setID('${employee.employee_Id}')"><i class="material-icons" data-toggle="tooltip"
                                                                            title="Delete">&#xE872;</i></a>
                        </td>
                    </tr>
                </c:forEach>
